...
% mex -O 3rd_party/cs2/cs2mex.c -output 3rd_party/cs2/cs2mex     %% compiling c implementation of push-relabel algorithm. It is downloaded from http://www.igsystems.com/cs2/index.html and then we mex'ed it to run faster in matlab.
...
legend('Dynamic programming', 'Succesive shortest path', 'NMS in the loop', 'location', 'NorthWest')
